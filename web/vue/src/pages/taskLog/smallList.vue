  ...
  <el-container>
    <el-main>
      ...
      <el-table :data="logs" border ref="table" style="width: 100%">
        ...
        <el-table-column prop="protocol" label="执行方式" :formatter="formatProtocol">
        </el-table-column>
        <el-table-column label="任务节点" width="150">
          <template slot-scope="scope">
        ...
        <el-table-column label="执行结果" width="120" v-if="this.isAdmin">
          <template slot-scope="scope">
            ...
            <el-button type="danger" v-if="scope.row.status === 1 && scope.row.protocol === 2" @click="stopTask(scope.row)">停止任务
            </el-button>
          </template>
        </el-table-column>
